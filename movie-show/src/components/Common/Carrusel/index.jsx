  ...
  return (
    itemsToShow.length ? (
      <div className="carousel-container">
        <div>
          <button onClick={previous} className="buttons">{<BsFillArrowLeftSquareFill size={60} />}</button>
        </div>
        <div>
        ...
        <div>
          <button onClick={next} className="buttons">{<BsFillArrowRightSquareFill size={60} />}</button>
        </div>
      </div>
    ) : null
  )
